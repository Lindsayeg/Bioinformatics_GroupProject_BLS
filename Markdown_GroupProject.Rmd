...
The goal of Further Exploration 2 was to explore the effect of genetic relatedness on the performance of our HMM model.  For exmaple, if our original protein sequences were based not on rodents but more distantly related mammals such as ceropithecidae, even toed ungulates, and marsupials, would our HMM model produce the same number of hits for the analyzed proteins (Atp12a, Gsta2, and Ptpn5).
